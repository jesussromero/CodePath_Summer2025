...
Given the root of a binary tree display representing the baked goods on display at your store, 
...
def is_balanced(display):
    #1. Check if each node visited is balanced.
    if display.left and display.right is None:
        count += 1
